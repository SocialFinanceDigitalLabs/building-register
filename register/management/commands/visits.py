...
class Command(BaseCommand):
    ...
    def handle(self, *args, output, summary, **options):
        ...
        ds = tablib.Dataset(
            headers=("user", "date", "sign_in", "sign_out"), title="Records"
        )
        ...
        if summary:
            ...
            ds_summary = tablib.Dataset(
                headers=("user", "days_signed_in", "days_not_signed_out", "pct"),
                title="Summary",
            )
